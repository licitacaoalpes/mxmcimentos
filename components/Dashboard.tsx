                ...
                <>
                  ...
                  {metrics.qtd_atrasadas > 0 && view === 'list' && (
                    <div className="rounded-2xl px-4 py-3 text-sm font-medium flex items-center gap-2"
                      ...
                      <span>
                        <strong>{metrics.qtd_atrasadas}</strong> transação(ões) em atraso
                        {metrics.qtd_parcial_atrasado > 0 && (
                          <span className="ml-1 opacity-80">
                            ({metrics.qtd_atrasadas - metrics.qtd_parcial_atrasado} sem pgto · {metrics.qtd_parcial_atrasado} com pgto parcial)
                          </span>
                        )}
                        {' '}— hora de cobrar!
                      </span>
